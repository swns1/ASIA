...
--
-- Name: application_invites; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.application_invites (
    invite_id uuid NOT NULL,
    access_code_hash character varying(200) NOT NULL,
    code_attempts smallint NOT NULL,
    locked_at timestamp with time zone,
    applicant_first_name character varying(50) NOT NULL,
...
--
-- Name: guardian_responses; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.guardian_responses (
    guardian_response_id bigint NOT NULL,
...
--
-- Name: guardian_responses_guardian_response_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

ALTER TABLE public.guardian_responses ALTER COLUMN guardian_response_id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.guardian_responses_guardian_response_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
CREATE TABLE public.student_applications (
    student_application_id bigint NOT NULL,
    ...
    duplicate_of_student_id bigint,
    duplicate_matches_json jsonb NOT NULL,
...
--
-- Name: student_applications_student_application_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

ALTER TABLE public.student_applications ALTER COLUMN student_application_id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.student_applications_student_application_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: application_invites application_invites_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.application_invites
    ADD CONSTRAINT application_invites_pkey PRIMARY KEY (invite_id);
...
--
-- Name: guardian_responses guardian_responses_enrollment_id_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.guardian_responses
    ADD CONSTRAINT guardian_responses_enrollment_id_key UNIQUE (enrollment_id);


--
-- Name: guardian_responses guardian_responses_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.guardian_responses
    ADD CONSTRAINT guardian_responses_pkey PRIMARY KEY (guardian_response_id);
...
ALTER TABLE ONLY public.student_applications
    ADD CONSTRAINT student_applications_pkey PRIMARY KEY (student_application_id);


--
-- Name: student_applications student_applications_submission_uuid_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.student_applications
    ADD CONSTRAINT student_applications_submission_uuid_key UNIQUE (submission_uuid);
...
--
-- Name: application_expires_6d9de9_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX application_expires_6d9de9_idx ON public.application_invites USING btree (expires_at);


--
-- Name: application_invites_expires_at_99a609e2; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX application_invites_expires_at_99a609e2 ON public.application_invites USING btree (expires_at);


--
-- Name: application_invites_issued_by_user_id_f9ec869e; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX application_invites_issued_by_user_id_f9ec869e ON public.application_invites USING btree (issued_by_user_id);
...
--
-- Name: student_app_last_na_180009_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX student_app_last_na_180009_idx ON public.student_applications USING btree (last_name, first_name);


--
-- Name: student_app_status_a2daa1_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX student_app_status_a2daa1_idx ON public.student_applications USING btree (status, submitted_at DESC);


--
-- Name: student_applications_birth_date_47f72fa2; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX student_applications_birth_date_47f72fa2 ON public.student_applications USING btree (birth_date);


--
-- Name: student_applications_created_student_id_ad5a06c1; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX student_applications_created_student_id_ad5a06c1 ON public.student_applications USING btree (created_student_id);


--
-- Name: student_applications_duplicate_of_student_id_f984fcec; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX student_applications_duplicate_of_student_id_f984fcec ON public.student_applications USING btree (duplicate_of_student_id);


--
-- Name: student_applications_invite_id_ceae6fb9; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX student_applications_invite_id_ceae6fb9 ON public.student_applications USING btree (invite_id);


--
-- Name: student_applications_last_name_9c03a841; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX student_applications_last_name_9c03a841 ON public.student_applications USING btree (last_name);


--
-- Name: student_applications_last_name_9c03a841_like; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX student_applications_last_name_9c03a841_like ON public.student_applications USING btree (last_name varchar_pattern_ops);


--
-- Name: student_applications_lrn_735bdaa1; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX student_applications_lrn_735bdaa1 ON public.student_applications USING btree (lrn);


--
-- Name: student_applications_lrn_735bdaa1_like; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX student_applications_lrn_735bdaa1_like ON public.student_applications USING btree (lrn varchar_pattern_ops);
...
CREATE INDEX student_applications_status_ee98b91a ON public.student_applications USING btree (status);


--
-- Name: student_applications_status_ee98b91a_like; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX student_applications_status_ee98b91a_like ON public.student_applications USING btree (status varchar_pattern_ops);


--
-- Name: student_applications_submitted_at_5f9d9c34; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX student_applications_submitted_at_5f9d9c34 ON public.student_applications USING btree (submitted_at);
...
--
-- Name: guardian_responses guardian_responses_enrollment_id_5d8f8b3e_fk_enrollmen; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.guardian_responses
    ADD CONSTRAINT guardian_responses_enrollment_id_5d8f8b3e_fk_enrollmen FOREIGN KEY (enrollment_id) REFERENCES public.enrollments(enrollment_id) DEFERRABLE INITIALLY DEFERRED;
...
--
-- Name: student_applications student_applications_invite_id_ceae6fb9_fk_applicati; Type: FK CONSTRAINT; Schema: public; Owner: -
--
