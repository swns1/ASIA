...
// CORPrintPage/ReportCardPage and InvoicePrintPage's
...
// copies all omitted, which meant a transferred-out student's COR/
// Report Card silently rendered with "Enrolled" styling via the old
