      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(150px,1fr))", gap: 12 }}>
        {[
          ...
          <div key={s.label} style={{ ...card, padding: "16px 20px", background: s.bg }}>
            <div style={{ fontSize: 11, fontWeight: 700, color: "#855c5c", textTransform: "uppercase", letterSpacing: "0.06em", marginBottom: 6 }}>{s.label}</div>
        ...
        {loading ? (
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 14 }}>
            ...
            <div>
              ...
              <div style={{ fontSize: 13, color: "#855c5c", marginTop: 2 }}>
