              ...
              <thead>
                <tr>
                  {["Sun","Mon","Tue","Wed","Thu","Fri","Sat"].map((d, i) => (
                    <th key={d} style={{ padding: "4px 0", textAlign: "center", fontSize: 9, fontWeight: 700, color: i === 0 || i === 6 ? "#e0a0a0" : "#8a6a6a", textTransform: "uppercase", letterSpacing: "0.06em", borderBottom: "1px solid #f0e4e4" }}>{d}</th>
                  ))}
                </tr>
              </thead>
              <tbody>
