  ...
  return (
    ...
    >
      ...
      <div>
        ...
        <div style={{ fontSize: 11, color: isActive ? color : "#855c5c", marginTop: 4, fontWeight: 500, textTransform: "uppercase", letterSpacing: "0.06em" }}>{label}</div>
      </div>
    </motion.div>
  );
}
          ...
          <div style={{ flex:1, overflowY:"auto", padding:"24px 28px", display:"flex", flexDirection:"column", gap:18 }}>
            ...
            <div style={{ display:"flex", gap:12 }}>
              {[
                ...
                { label:"Cancelled",         icon:"ti-user-x",         value: statusCounts.cancelled, color:"#9b2020", bg:"#fde8e8", status:"cancelled" },
              ].map((card, i) => (
                <motion.div
                  key={card.label}
