...
// ── Styles ────────────────────────────────────────────────────────────────────
const s = {
  page: { display: "flex", minHeight: "100vh", fontFamily: "'DM Sans', sans-serif", background: "#faf9f6" },
  sidebar: {
  ...
  section: { fontSize: 10.5, fontWeight: 700, color: "#c8c0b4", letterSpacing: "0.08em", textTransform: "uppercase", padding: "18px 22px 6px" },
  navBtn: (active) => ({
  ...
  filterLabel: { fontSize: 11, fontWeight: 600, color: "#8a8480", textTransform: "uppercase", letterSpacing: "0.05em" },
  select: {
    padding: "8px 12px", borderRadius: 8, border: "1px solid #e0dcd4", fontSize: 13,
    color: "#3a3a3a", background: "white", cursor: "pointer", fontFamily: "'DM Sans', sans-serif",
  },
  runBtn: {
    ...
    boxShadow: "0 4px 14px rgba(224,49,49,0.25)",
    transition: "all 0.12s",
  },
  emptyState: {
    display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center",
    padding: "60px 20px", color: "#c0b8b0", textAlign: "center",
  },
};
      ...
      {hovered && (() => {
        ...
        return (
          <g>
            ...
            <text x={rx + 10} y={ry + 33} fontSize="11" fill="#8a8480" fontFamily="DM Sans">{hovered.student_number}</text>
...
const thStyle = { padding: "10px 14px", textAlign: "left", fontSize: 11, fontWeight: 700, color: "#a09890", textTransform: "uppercase", letterSpacing: "0.05em" };
          ...
          <div style={s.card}>
            <div style={s.emptyState}>
              ...
              <div style={{ fontSize: 12, color: "#b0a898", marginTop: 4, maxWidth: 340, lineHeight: 1.6 }}>
                Select your filters above and click <strong style={{ color: "#e03131" }}>Run Analysis</strong> to
                cluster students by their academic performance.
              </div>
            </div>
          </div>
        )}
